...
8. Lakukan pencarian menggunakan kotak pencarian di bawah tombol untuk memilih rak buku (kategori). Masing-masing rak memiliki kotak pencarian sendiri yang berwarna putih dan terdapat ikon kaca pembesar di sebelah kanan. Pencarian bisa dilakukan untuk mencari Judul Buku, Nama Pengarang, atau Tahun Terbit di rak buku terkait.
...
## Hal Penting:
Per waktu dan tanggal 5:23 PM 7/21/2021, aplikasi web Rakbuku masih dalam tahap pengembangan dan belum dilakukan optimasi secara visual untuk digunakan di tablet maupun desktop. Namun, secara fitur dan fungsionalitas seharusnya tidak ada kendala baik di mobile/tablet/desktop.
