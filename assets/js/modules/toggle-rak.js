 ...
 */
const setRakNotActive = (btnEl, contentEl) => {
...
allToggleBtn.forEach((btn) => {
  btn.addEventListener('click', (e) => {
    ...
    // nyalain btn yg diklik, matiin btn lainnya
    if (btn.className.includes('toggle__btn__active')) {
      if (idBtn === 'left-content-btn') {
        setRakNotActive(leftContentBtnEl, leftContentEl)
      } else if (idBtn === 'right-content-btn') {
        setRakNotActive(rightContentBtnEl, rightContentEl)
      }
    } else {
      if (idBtn === 'left-content-btn') {
