...
<div id="${id}-cardWrapper" class="card__wrapper">
  <article id="${id}" tabindex="0" class="card">
    ...
    <button id="${id}-optionBtn" class="card__option__btn" type="button" data-toggle="modal" data-target="#${id}-modal">
    ...
    <div id="${id}-modalDecor" class="right__arrow hidden"></div>
    
    <div id="${id}-modalMimic" class="card__modal__mimic hidden" style="width:0; height:0;"></div>
